        ...
        <div class="row">
          ...
          <div class="col-md-2">
            <div class="form-group">
              ...
              <input type="text" class="form-control campo-moeda valor" name="valor" id="valor" placeholder="00,00">
            </div>
          </div>
    ...
    <div class="card-body">
      ...
      <table class="table tabela-ajustada table-striped">
        ...
        <tbody>
          ...
          <tr>
            <td><img class="imagem-perfil" src="#"></td>
      ...
      <center style="margin-top:20px">
        <div>
          ...
          <span class="badge" style="background:#83e6cd;padding:5px">
            <?php echo $tipo->legenda; ?> R$ <?php echo ($tipo->totalVendas); ?>
          </span>
        ...
        <?php else : ?>
        <small>Vendido ontem: <b>R$ <?php echo ($totalVendaNoDiaAnterior); ?></b></small>
        <?php endif; ?>
