        ...
        <div class="row div-inter-produtos">
          ...
          <div class="col-lg-2 card-produtos <?php echo $seProdutoEsgotado == 'esgotado' ? 'estoque_esgotado' : false; ?>">
            <?php if (!is_null($produto->imagem) && $produto->imagem != '') : ?>
              <img src="#" title="Adicionar!">
              @else
              <i class="fas fa-box-open icone-produtos" style="font-size:50px" title="Adicionar!"></i>
              @endif

              <center>
                <span class="produto-titulo">{{$produto->nome}};
                </span>
              </center>
              <center><span class="produto-valor">R$ {{$produto->preco}}; </span></center>
  ...
  <div class="card col-lg-4 content-div div-realizar-pagamento">
    <div class="card-body div-card-body-realizar-pagamento">
      ...
      <div class="form-group" id="div-valor-recebido" style="display:none">
        ...
        <input type="text" class="form-control campo-moeda" id="valor_recebido" name="valor_recebido" placeholder="R$ 00,00" onblur="calcularTroco();">
      </div>
